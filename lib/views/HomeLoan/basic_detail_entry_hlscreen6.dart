...
class BasicDetailEntryHLScreen extends BaseRoute {
  void UploadDocumentHLScreen({a, o}) {
    // Implementation for UploadDocumentPLScreen
  }
  void UploadDocumentTransferHLScreen({a, o}) {
    // Implementation for UploadDocumentPLScreen
  }
  BasicDetailEntryHLScreen({a, o})
      : super(a: a, o: o, r: 'BasicDetailEntryHLScreen');
                          ...
                          Row(
                            children: [
                              Radio(
                                  value: 1,
                                  groupValue:
                                      homeLoanController.isTopUpLoanRequired,
                                  onChanged: (val) {
                                    homeLoanController
                              ...
                              Padding(
                                ...
                                child: CustomTextFormField(
                                  ...
                                  textInputType: TextInputType.numberWithOptions(
                                      decimal: true,
                                      signed:
                                          true), // Provide the input type you want
                                  prefixIcon: Icon(
        ...
        child: Column(
          children: [
            ...
            Padding(
              padding: EdgeInsets.only(top: 8),
              child: CustomTextFormField(
                textEditingController: cBirthdate, // Provide a controller
                hintText: "Select birthdate",
                obscureText: false,
                textInputType:
                    TextInputType.number, // Provide the input type you want
                prefixIcon: Icon(Icons.person), // Provide a prefix icon
                suffixIcon: Icon(Icons.clear), // Provide a suffix icon
                maxLength: 100, // Provide a max length
                onChanged: (value) {
                  ...
                  ? Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: CustomTextFormField(
                            textEditingController:
                                cBirthdateOfCoApplicant, // Provide a controller
                            hintText: "Type here",
                            obscureText: false,
                            textInputType: TextInputType
                                .text, // Provide the input type you want
                        ...
                        Padding(
                          padding: EdgeInsets.only(top: 8),
                          child: GetBuilder<HomeLoanController>(
                              builder: (controler) {
                            return Row(
                              children: [
                                Row(
                    ...
                    Row(
                      children: [
                        Radio(
                            value: 1,
                            groupValue:
                                homeLoanController.isCorrespondingAddressSame,
                            onChanged: (val) {
                              homeLoanController
        ...
        child: Column(
          children: [
            ...
            GetBuilder<HomeLoanController>(builder: (controller) {
              return Padding(
                padding: EdgeInsets.only(top: 15),
                child: homeLoanController.employemenTypeVal ==
                            'Self-employed' ||
                        homeLoanController.employemenTypeVal == 'Salaried'
                    ? DottedBorder(
                        strokeWidth: 1,
                        color: Colors.black,
                        child: Padding(
