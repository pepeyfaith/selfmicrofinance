...
class HomeLoanController extends GetxController {
  List<String> propetyTypeList = [
    "Fully Constructed - Apartment",
    "Fully Constructed - Individual House",
    "Under Constructed - Apartment",
    "Under Constructed - Individual House",
    "Only Plot Purchase",
    "Construction On Pre-owned Plot",
    "Plot Purchase and Construction"
  ];
  int indexValue = 0.obs();
  List<String> relationList = ["Father", "Mother", "Sister/Brother", "Spouse"];
  List<String> employementTypeList = [
    "Salaried",
    "Self-employed",
    "Homemaker",
    "Unemployed",
