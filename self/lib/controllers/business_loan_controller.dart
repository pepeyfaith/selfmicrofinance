...
class BusinessLoanController extends GetxController {
  ...
  late File photoOfPropIndi;
  late File panCard;
  late File aadharCard;
  late File electricityBill;
  late File companyIdCard;
  late File gstRegistration;
  List<File> partnerAadharCards = [];
  late File partnerAadharCard;
  late File panCardPartnershipFirm;
  List<File> partnerPanCards = [];
  late File partnerPanCard;
  List<File> photoOfPartners = [];
  late File photoOfPartner;
  late File partnershipDeed;
  late File registration;
  late File plBalanceSheet;
  late File panCardLimitedCompany;
  late File directorPanCard;
  List<File> directorPanCards = [];
  late File directorAadharCard;
  List<File> directorAadharCards = [];
  late File photoOfDirector;
