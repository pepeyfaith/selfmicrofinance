...
class LoanApplicationScreen extends BaseRoute {
  LoanApplicationScreen({a, o, phone_number})
      : super(a: a, o: o, r: 'LoanApplicationScreen');
  late DateTime _fromDate;
  late DateTime _toDate;
  late TabController _tabController;

  final LoanApplicationController loanController =
                        ...
                        children: [
                          ...
                          Container(
                              ...
                              child: CustomDropDown(
                                ...
                                onChanged: (selectedValue) {
                                  loanController.loantypelistVal =
                                      selectedValue.toString();
                                },
                              )),
                        ],
  ...
  Future _selectFromDate(context) async {
    try {
      ...
      if (picked != null && picked != DateTime(2000)) {
        _fromDate = picked;
        loanController.cfromdate.text =
            formatDate(_fromDate, [dd, '-', mm, '-', yyyy]);
      }
    } catch (e) {
      print(
          'Exception - loan_list_screen - _selectFromDate(): ' + e.toString());
    }
  }
  ...
  Future _seletToDate(context) async {
    try {
      ...
      if (picked != null && picked != DateTime(2000)) {
        _toDate = picked;
        loanController.ctodate.text =
            formatDate(_toDate, [dd, '-', mm, '-', yyyy]);
      }
    } catch (e) {
