...
//   BasicDetailEntryLAPScreen({a, o})
//       : super(a: a, o: o, r: 'BasicDetailEntryLAPScreen');
...
//   final LoanAgainstPropertyController loanAgainstPropertyController =
//       Get.find<LoanAgainstPropertyController>();

//   final _pageController = PageController();
//   late DateTime _selectedBirthdate;
//   late DateTime _selectedBirthdateOfCoApplicant;
//   late DateTime _selectedApproxeDateOfLoan;
...
//                               .setPropertyType(selectedValue.toString());
//                         },
//                       )),
//                   Container(
//                     width: Get.width,
...
//                   Padding(
//                     padding: EdgeInsets.only(top: 8),
//                     child: GetBuilder<LoanAgainstPropertyController>(
//                         builder: (controler) {
//                       return Row(
//                         children: [
//                           Row(
...
//                               Radio(
//                                   value: 1,
//                                   groupValue: loanAgainstPropertyController
//                                       .isTopUpLoanRequired,
//                                   onChanged: (val) {
//                                     loanAgainstPropertyController
//                                         .setTopUpLoanRequired(val as int);
//                                   }),
//                               Text(
//                                 'Yes',
...
//                     }),
//                   ),
//                   GetBuilder<LoanAgainstPropertyController>(
//                       builder: (controller) {
//                     return loanAgainstPropertyController.isTopUpLoanRequired ==
//                             1
//                         ? Column(
//                             children: [
//                               Container(
...
//                             value: 1,
//                             groupValue:
//                                 loanAgainstPropertyController.maritalStatus,
//                             onChanged: (val) {
//                               loanAgainstPropertyController
...
//                             value: 1,
//                             groupValue:
//                                 loanAgainstPropertyController.isCoApplicant,
//                             onChanged: (val) {
//                               loanAgainstPropertyController
//                                   .setCoApplicant(val as int);
//                             }),
//                         Text(
//                           'Yes',
//                           style: Theme.of(context).primaryTextTheme.headline3,
...
//                                         onChanged: (val) {
//                                           loanAgainstPropertyController
//                                               .setCoApplicantMaritalStatus(val);
//                                         }),
//                                     Text(
//                                       'Other',
//                                       style: Theme.of(context)
...
//                               onChanged: (selectedValue) {
//                                 loanAgainstPropertyController
//                                     .setRelation(selectedValue.toString());
//                               },
//                             )),
//                       ],
//                     )
...
//                             value: 1,
//                             groupValue: loanAgainstPropertyController
//                                 .isCorrespondingAddressSame,
//                             onChanged: (val) {
//                               loanAgainstPropertyController
//                                   .setCorrespondingAddress(val);
//                             }),
//                         Text(
//                           'Yes',
//                           style: Theme.of(context).primaryTextTheme.headline3,
...
//             ),
//             GetBuilder<LoanAgainstPropertyController>(builder: (controller) {
//               return loanAgainstPropertyController.isCorrespondingAddressSame ==
//                       2
//                   ? Column(
//                       children: [
//                         Container(
...
//               return loanAgainstPropertyController.employemenTypeVal ==
//                       'Salaried'
//                   ? Column(
//                       children: [
//                         Container(
...
//                               onChanged: (selectedValue) {
//                                 loanAgainstPropertyController
//                                     .setServiceType(selectedValue.toString());
//                               },
//                             )),
//                         Container(
//                           width: Get.width,
...
//                                     .hintStyle,
//                               ),
//                               list: loanAgainstPropertyController
//                                   .employeNatureList,
//                               val: loanAgainstPropertyController
//                                   .employeNatureVal,
//                               onChanged: (selectedValue) {
//                                 loanAgainstPropertyController
...
//               return Padding(
//                 padding: EdgeInsets.only(top: 15),
//                 child: loanAgainstPropertyController.employemenTypeVal ==
//                             'Self-employed' ||
//                         loanAgainstPropertyController.employemenTypeVal ==
//                             'Salaried'
//                     ? DottedBorder(
//                         strokeWidth: 1,
//                         color: Colors.black,
...
//                   onChanged: (selectedValue) {
//                     loanAgainstPropertyController
//                         .setResidenceType(selectedValue.toString());
//                   },
//                 )),
//             Container(
//               width: Get.width,
...
//               loanAgainstPropertyController
//                   .setIndex(_currentPageNotifier.value);
//             }),
//       );
//     }
