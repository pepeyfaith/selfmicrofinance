...
//   BasicDetailEntryBLScreen({a, o})
//       : super(a: a, o: o, r: 'BasicDetailEntryBLScreen');

//   final SplashController customerController = Get.put(SplashController());

//   final BusinessLoanController businessLoanController =
//       Get.find<BusinessLoanController>();
...
//                 child: Text(
//                   'Full Name (As per Bank Account Card)',
...
//                           .setCompanyType(selectedValue.toString());
//                     },
//                   )),
//               Container(
//                 width: Get.width,
...
//                     onChanged: (selectedValue) {
//                       businessLoanController.industryVal =
...
//                     onChanged: (selectedValue) {
//                       businessLoanController.stateVal =
//                           selectedValue.toString();
//                     },
...
//                   )),
//               businessLoanController.companyTypeVal == 'Partnership' ||
//                       businessLoanController.companyTypeVal == 'LLP' ||
